...
const Shape* shapes[] = {
    new Sphere(0.5, Vec(0, 8, 2),      Vec(25,25,25), blackSurf),   // Light
    ...
    new STLModel("pikachu.stl", yellowSurf, Vec(2, 2, 0), Vec(), true, 4),
    new STLModel("dodecahedron.stl", greenSurf, Vec(-2, 2.5, -2), Vec(), true, 2.5)
};
